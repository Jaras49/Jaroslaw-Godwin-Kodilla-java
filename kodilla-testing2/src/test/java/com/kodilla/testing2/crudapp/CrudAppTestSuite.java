...
public class CrudAppTestSuite {
    ...
    private boolean checkTaskExistsInTrello(String name) throws InterruptedException {
        ...
        driver.findElement(By.id("user")).sendKeys("jaras48@gmail.com");
        driver.findElement(By.id("password")).sendKeys("trellopass");
        driver.findElement(By.id("login")).submit();

        Thread.sleep(3000);

        driver.findElement(By.xpath("//a[contains(@href, \"/jarosawgodwin/boards\")]")).click();
        ...
        result = driver.findElements(By.xpath("//span[@class=\"list-card-title js-card-name\"]")).stream()
                .filter(theSpan -> theSpan.getText().contains(name))
